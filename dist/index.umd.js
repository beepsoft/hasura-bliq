(function (global, factory) {
    ...
    (factory((global.hasuraHooks = {}),global.react,global.graphql,global.mobxStateTree,global.gql));
    ...
    function useSubscription(params) {
      ...
      }, [lastStartDate, finished]); // Return info and controls for managing the subscription
    ...
    function useSubscriptionWithStore(params) {
      ...
      var storeHandler = function (data) {
        console.log("storeHandler: ", data);

        if (params.onData) {
          var x = params.store.merge(getFirstValue(data));
          console.log("XXXXXX", x);
          params.onData(data);
        }
      };

      var subscriptionInfo = useSubscription({
    ...
    exports.useSubscriptionWithStore = useSubscriptionWithStore;
