...
function useLiveQuery(params) {
  ...
  var subscription = useRef({}); // Make sure config contains the lastStartDate we start from
  ...
  useEffect(function () {
    ...
    var sub = gqlWsClient.request({
      ...
      next: function next(data) {
        ...
        var deltaQuery = print(prepareDeltaQuery(queryDoc, config));
...
export { useLiveQuery, useLiveQueryWithStore };
